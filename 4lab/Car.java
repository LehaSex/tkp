...
public class Car extends Auto {// файл Car.java
    ...
    public Car(String firma, int speed, String gos, String name, int n, Boolean f) {
        super(firma, speed, gos); // вызываем конструктор класса-родителя с параметрами (см. класс Auto)
...
public String toString(){ 
    return getFirm()+" "+model+" "+getMaxSpeed()+" макс. км/ч, "+numDoors+" дверей, "+((fullTime) ? "полный привод, " : "не полный привод, ")+getGos() + " гос. номер";
}
}